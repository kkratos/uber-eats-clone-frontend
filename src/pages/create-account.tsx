...
const CreateAccount = () => {
    const { register, watch, formState: { errors, isValid }, handleSubmit, getValues } = useForm<ICreateAccountForm>({
        mode: 'onChange',
        defaultValues: {
    ...
    return (
        <div className="h-screen flex items-center flex-col mt-10 lg:mt-28">
            ...
            <div className="w-full max-w-sm flex flex-col px-5 items-center ">
                ...
                <h4 className="w-full text-left font-medium text-2xl mb-1">Let's get started</h4>
